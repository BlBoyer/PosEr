param(
    ...
    $PSSettings = "$env:USERPROFILE\AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState\settings.json"
    ...
    $SettingsObject | ConvertTo-Json -Depth 100 | Set-Content $PSSettings
